<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici/ana.Master" AutoEventWireup="true" CodeBehind="gruplar.aspx.cs" Inherits="Dershane.yonetici.gruplar" %>
        ...
        <div class="portlet-body form form-horizontal form-bordered">
            <section id="form-username" class="form-horizontal form-bordered">
                <div class="form-group">
                    <label class="col-sm-3 control-label">Grup Adı</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtGrupAdi" CssClass="form-control" runat="server" />
                    </div>
                </div>
        ...
        <div class="portlet-body">
            <div class="table-scrollable">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <asp:Repeater ID="rptGrup" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td><%#Eval("#") %>
                                    </td>
                                    ...
                                    <td>
                                        <a href='grup_sil.aspx?id=<%#Eval("grupID") %>' class="btn btn-danger"><i class="fa fa-remove"></i>
                                            Sil
                                        </a>
                                    </td>
                                </tr>
