<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici/ana.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="donemler.aspx.cs" Inherits="Dershane.yonetici.donemler" %>
        ...
        <div class="portlet-body form form-horizontal form-bordered">
            <section id="form-username" class="form-horizontal form-bordered">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtDonemAdi" CssClass="form-control" runat="server" />
                    </div>
                </div>
        ...
        <div class="portlet-body">
            <div class="table-scrollable">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <asp:Repeater ID="rptDonem" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td><%#Eval("#") %>
                                    </td>
                                    ...
                                    <td>
                                        <a href='donem_sil.aspx?id=<%#Eval("donemID") %>' class="btn btn-danger"><i class="fa fa-remove"></i>
                                            Sil
                                        </a>
                                    </td>
                                </tr>
