        ...
        <div class="portlet-body form form-horizontal form-bordered">
            <section id="form-username" class="form-horizontal form-bordered">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtBolumAdi" CssClass="form-control" runat="server" />
                    </div>
                </div>
        ...
        <div class="portlet-body">
            <div class="table-scrollable">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <asp:Repeater ID="rptBolum" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td><%#Eval("#") %>
                                    </td>
                                    ...
                                    <td>
                                        <a href='bolum_sil.aspx?id=<%#Eval("bolumID") %>' class="btn btn-danger"><i class="fa fa-remove"></i>
                                            Sil
                                        </a>
                                    </td>
                                </tr>
