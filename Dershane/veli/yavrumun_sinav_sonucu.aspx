<%@ Page Title="" Language="C#" MasterPageFile="~/veli/veli.Master" AutoEventWireup="true" CodeBehind="yavrumun_sinav_sonucu.aspx.cs" Inherits="Dershane.veli.yavrumun_sinav_sonucu" %>
<asp:Content ID="Content1" ContentPlaceHolderID="baslik" runat="server">
    Yavrumun Sınav Sonuçları
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="icerik" runat="server">
    ...
    <div class="portlet box green-haze">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cogs"></i>Yavrumun Sınav Sonuçları
            </div>
            <div class="tools">
