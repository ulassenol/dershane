<%@ Page Title="" Language="C#" MasterPageFile="~/veli/veli.Master" AutoEventWireup="true" CodeBehind="yavrumun_yoklamasi.aspx.cs" Inherits="Dershane.veli.yavrumun_yoklamasi" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="icerik" runat="server">
    ...
    <div class="portlet box green-haze">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cogs"></i>Yavrumun Yoklaması
            </div>
            <div class="tools">
